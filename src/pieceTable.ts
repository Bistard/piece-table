import { ByteSize } from "src/utility/byteSize";
import { Character, CharCode } from "src/utility/char";
import { Mutable } from "src/utility/type";
import { Position, IPosition, EndOfLine, IBufferPosition, IPiece, IPiecePosition, IPieceTable, IPieceNode, RBColor, IPieceNodePosition } from "src/index";
...
export class PieceTable implements IPieceTable {
    ...
    public getPositionAt(textOffset: number): IPosition {
        ...
        while (node !== NULL_NODE) {
            ...
            // current piece has enough buffer length for the required text offset.
                ...
                if (position.lineNumber === 0) {
                    ...
                    return new Position(lineNumber, lineOffset);
                }
                
                return new Position(lineNumber, position.lineOffset);
            }
            // go right
            else {
